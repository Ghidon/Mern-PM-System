    ...
    if (task.status === "To do") {
      return (
        <svg
          ...
          height="18"
          fill="currentColor"
          class="bi bi-shield-fill text-secondary"
          viewBox="0 0 16 16"
        >
      ...
      return (
        <svg
          ...
          height="18"
          fill="currentColor"
          class="bi bi-shield-shaded text-warning"
          viewBox="0 0 16 16"
        >
          <path
            fill-rule="evenodd"
      ...
      return (
        <svg
          ...
          height="18"
          fill="currentColor"
          class="bi bi-shield-fill-exclamation text-danger"
          viewBox="0 0 16 16"
        >
          <path
            fill-rule="evenodd"
      ...
      return (
        <svg
          ...
          height="18"
          fill="currentColor"
          class="bi bi-shield-fill-check text-success"
          viewBox="0 0 16 16"
        >
          <path
            fill-rule="evenodd"
          ...
          >
            {doorOpen ? (
              ...
              <svg
                ...
                height="25"
                fill="currentColor"
                class="bi bi-door-closed-fill text-secondary"
                viewBox="0 0 16 16"
              >
